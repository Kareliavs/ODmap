import {
  ...
  init_esm12 as init_esm4,
  init_esm14 as init_esm5,
...
var require_earcut = __commonJS({
  "node_modules/earcut/src/earcut.js"(exports, module) {
    ...
    function filterPoints2(start, end) {
      ...
      do {
        again = false;
        if (!p.steiner && (equals3(p, p.next) || area2(p.prev, p, p.next) === 0)) {
          removeNode2(p);
          p = end = p.prev;
          if (p === p.next)
            break;
    ...
    function cureLocalIntersections2(start, triangles, dim) {
      ...
      do {
        ...
        if (!equals3(a, b) && intersects2(a, p, p.next, b) && locallyInside2(a, b) && locallyInside2(b, a)) {
    ...
    function isValidDiagonal2(a, b) {
      ...
      equals3(a, b) && area2(a.prev, a, a.next) > 0 && area2(b.prev, b, b.next) > 0);
    }
...
export {
  ...
  GeoJsonLayer,
  esm_exports,
  init_esm7 as init_esm2
};
//# sourceMappingURL=chunk-NC3VIFUK.js.map
